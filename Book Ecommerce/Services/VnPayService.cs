...
namespace Book_Ecommerce.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model, string paymentBackUrl)
        {
            ...
            vnpay.AddRequestData("vnp_ReturnUrl", paymentBackUrl);
